<footer
	class="mx-auto flex max-w-[1340px] flex-col items-center justify-between gap-4 border-t px-4 py-8 sm:flex-row sm:gap-0 sm:px-8"
	style="border-color: var(--color-line); border-width: var(--border-w) 0 0 0;"
>
