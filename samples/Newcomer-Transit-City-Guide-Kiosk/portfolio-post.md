# Newcomer Transit and City Guide Kiosk
...
- Technology Tags: React, Google Maps API, react-i18next, Material UI, QR Code
- Capability Tags: Interface Design, Kiosk UX, State-Based Navigation, API Integration, Localization, Frontend Prototyping
