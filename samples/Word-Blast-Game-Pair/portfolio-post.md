...
Taken together, these two repositories show:

- a browser game built without a framework
- a clear progression from scaffolded architecture to working runtime
- class-based client-side game state
- timed turn sequencing
- constrained-input validation against a generated letter rack
- dynamic DOM rendering and intermission/game state switching
- browser-side dictionary validation
- streamed AI integration
- custom incremental JSON assembly for streamed API data

The defining characteristic of the combined project is that it pairs a small, readable browser game with one unusually ambitious feature for its scale: an AI mode that is integrated into the same word-submission flow as a human player through streamed output and custom parsing.

## Tags

- Project Size: Medium
- Technical Skill Level: High
- Technology Tags: HTML, CSS, JavaScript, OpenAI API, WordsAPI
- Capability Tags: Game Design, Interface Design, DOM State Management, Streaming, API Integration, JSON Parsing
